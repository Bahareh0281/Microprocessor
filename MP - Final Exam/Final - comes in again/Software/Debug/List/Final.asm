...
_0x0:
	...
	.DB  0x4B,0x61,0x76,0x6F,0x75,0x73,0x69,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 002B int i = 14;
; 0000 002C int j = 0;
; 0000 002D int posx = 0;
; 0000 002E int posy = 0;
...
; 0000 0053 // Clock value: 31.250 kHz
...
; 0000 005E TCCR1A=(0<<COM1A1) | (0<<COM1A0) | (0<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (0<<WGM10);
	OUT  0x2F,R30
; 0000 005F TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (1<<WGM12) | (1<<CS12) | (0<<CS11) | (0<<CS10);
	LDI  R30,LOW(12)
	OUT  0x2E,R30
...
; 0000 0063 ICR1L=0x00;
	OUT  0x26,R30
; 0000 0064 OCR1AH=0x7A;
	LDI  R30,LOW(122)
	OUT  0x2B,R30
; 0000 0065 OCR1AL=0x12;
	LDI  R30,LOW(18)
	OUT  0x2A,R30
...
; 0000 0074 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (1<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (0<<TOIE0);
	LDI  R30,LOW(16)
	OUT  0x39,R30
; 0000 0075 
...
_0x3:
; 0000 00A7           {
; 0000 00A8           char* name = "Bahareh Kavousi";
; 0000 00A9           for(j=0, i=14;j<15, i >= 0;j++, i--)
	SBIW R28,2
	LDI  R30,LOW(_0x6)
	LDI  R31,HIGH(_0x6)
	ST   Y,R30
...
; 0000 00B5                   posx -= 16;
	__SUBWRN 20,21,16
; 0000 00B6               }
; 0000 00B7               lcd_gotoxy( posx, posy);
_0xD:
	ST   -Y,R20
	LDD  R26,Y+3
	RCALL _lcd_gotoxy
; 0000 00B8               lcd_putchar(name[j]);
	MOVW R30,R18
	LD   R26,Y
	LDD  R27,Y+1
	ADD  R26,R30
