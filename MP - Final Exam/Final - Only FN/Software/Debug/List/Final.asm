...
;Version :
;Date    : 5/26/2024
;Author  : Bahareh Kavousi nejad - 99431217
;Company : IUST
;Comments:
;
;
...
_0x3:
; 0000 00A7           {
; 0000 00A8           char* name = "Kavousi";
; 0000 00A9           for(j=0, i=8;j<7, i >= 0;j++, i--)
	SBIW R28,2
	LDI  R30,LOW(_0x6)
	LDI  R31,HIGH(_0x6)
	ST   Y,R30
...
; 0000 00AF                   posx -= 16;
	__SUBWRN 20,21,16
; 0000 00B0               }
; 0000 00B1               lcd_gotoxy( posx, posy);
_0xA:
	ST   -Y,R20
	LDD  R26,Y+3
	RCALL _lcd_gotoxy
; 0000 00B2               lcd_putchar(name[j]);
	MOVW R30,R18
	LD   R26,Y
	LDD  R27,Y+1
	ADD  R26,R30
