...
_0x0:
	.DB  0x42,0x61,0x68,0x61,0x72,0x65,0x68,0x20
	.DB  0x4B,0x61,0x76,0x6F,0x75,0x73,0x69,0x20
	.DB  0x6E,0x65,0x6A,0x61,0x64,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0041     PORTD=(0<<PORTD7) | (0<<PORTD6) | (0<<PORTD5) | (0<<PORTD4) | (0<<PORTD3) | (0<<PORTD2) | (0<<PORTD1) | (0<<PORTD0);
	OUT  0x12,R30
; 0000 0042 
; 0000 0043     // USART initialization
; 0000 0044     // Communication Parameters: 8 Data, 1 Stop, No Parity
; 0000 0045     // USART Receiver: On
; 0000 0046     // USART Transmitter: On
; 0000 0047     // USART Mode: Asynchronous
; 0000 0048     // USART Baud Rate: 9600
; 0000 0049     UCSRA=0x00;
	OUT  0xB,R30
; 0000 004A     UCSRB=0x18;
	LDI  R30,LOW(24)
	OUT  0xA,R30
; 0000 004B     UCSRC=0x86;
	LDI  R30,LOW(134)
	OUT  0x20,R30
; 0000 004C     UBRRH=0x00;
	LDI  R30,LOW(0)
	OUT  0x20,R30
; 0000 004D     UBRRL=0x33;
	LDI  R30,LOW(51)
	OUT  0x9,R30
; 0000 004E 
; 0000 004F     // Alphanumeric LCD initialization
; 0000 0050     // Connections are specified in the
; 0000 0051     // Project|Configure|C Compiler|Libraries|Alphanumeric LCD menu:
; 0000 0052     // RS - PORTC Bit 0
; 0000 0053     // RD - PORTC Bit 1
; 0000 0054     // EN - PORTC Bit 2
; 0000 0055     // D4 - PORTC Bit 4
; 0000 0056     // D5 - PORTC Bit 5
; 0000 0057     // D6 - PORTC Bit 6
; 0000 0058     // D7 - PORTC Bit 7
; 0000 0059     // Characters/line: 16
; 0000 005A 
...
; 0000 0069                 usart_send_string("Bahareh Kavousi nejad");
	__POINTW2MN _0xB,0
	RCALL _usart_send_string
; 0000 006A                 putchar(0x0D);
	CALL SUBOPT_0x0
; 0000 006B                 putchar(0x0A);
; 0000 006C                 break;
	RJMP _0x8
; 0000 006D             case 'c':
_0xA:
...
; 0000 0076                 lcd_clear();
	RCALL _lcd_clear
; 0000 0077                 lcd_puts("Bahareh Kavousi nejad");
	__POINTW2MN _0xB,22
	RCALL _lcd_puts
; 0000 0078                 break;
; 0000 0079         }
...
;
;void usart_send_string(char *str) {
; 0000 007D void usart_send_string(char *str) {

	.CSEG
_usart_send_string:
; 0000 007E     for(i=0;str[i];i++)
	ST   -Y,R27
	ST   -Y,R26
;	*str -> Y+0
	CLR  R5
