...
; 0000 0022 interrupt [2] void ext_int0_isr(void) {
...
; 0000 002E interrupt [4] void ext_int2_isr(void) {
_ext_int2_isr:
	ST   -Y,R30
	ST   -Y,R31
	IN   R30,SREG
...
; 0000 0042     // INT1: On
; 0000 0043     // INT1 Mode: Falling Edge
; 0000 0044     // INT2: On
; 0000 0045     // INT2 Mode: Falling Edge
; 0000 0046     GICR|=0xE0;
	IN   R30,0x3B
	ORI  R30,LOW(0xE0)
	OUT  0x3B,R30
; 0000 0047     MCUCR=0x0A;
	LDI  R30,LOW(10)
	OUT  0x35,R30
